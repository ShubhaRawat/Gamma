...
export default function TextEditor() {
  ...
  return (
    <Card className="w-full flex justify-start max-w-4xl mx-auto bg-[#2e294e] border-none shadow-xl">
      <CardHeader className="flex flex-row justify-between space-y-0 px-4 py-3">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <div className="flex items-center justify-center bg-white/90 hover:bg-white p-1.5 rounded-md transition-colors">
                <svg
      ...
      <CardContent className="p-4 w-full">
        <div 
          className="min-h-[100px] w-full rounded-lg bg-white/10 p-6 text-white/90 focus:outline-none"
          style={{
            textAlign: alignment
          }}
          contentEditable
        ...
        >
          <span className="text-white/50 text-4xl">Untitled Card...</span>
        </div>
      </CardContent>
    </Card>
  )
